        ...
        <div className="row">
          <div className="col-xl-6 col-lg-7">
            <div className="fugu-hero-content">
              ...
              <p className="wow fadeInUpX" data-wow-delay="0.25s">
                an intuitive marketplace delivering meals you've seen but never
                tried
              </p>
              <div
              ...
              <div
                className="fugu-hero-client-area wow fadeInUpX"
          ...
          <div className="col-xl-6 col-lg-5">
            <div className="fugu-hero-thumb">
              <img src="/images/all-img/prep-banner-mobile.png" alt="title" />
