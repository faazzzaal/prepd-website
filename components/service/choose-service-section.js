      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-6">
            <div
              className="fugu-iconbox-wrap fugu-iconbox-wrap5 wow fadeInUpX"
              data-wow-delay="0s"
            >
              ...
              <div className="fugu-iconbox-data">
                ...
                <p>
                  Security tokens are digital that represent & transferred
                  ownership rights to a blockchain token.
                </p>
          ...
          <div className="col-lg-6">
            ...
            >
              <div className="fugu-iconbox-icon">
                <img src="/images/all-img/icon2_2.png" alt="" />
              </div>
              <div className="fugu-iconbox-data">
                <h4>Ownership over your coins</h4>
                <p>
                  The most reliable way to prove ownership of crypto currencies
                  is to sign a specified message with a key.
                </p>
                <Link href="single-service" legacyBehavior>
                  <a className="fugu-icon-btn">
                    Discover More{" "}
          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <div className="fugu-iconbox-data">
                ...
                <p>
                  A cold wallet, otherwise known as a hardware wallet cold
                  storage, is a physical device that keeps offline.
                </p>
                <Link href="single-service" legacyBehavior>
                  <a className="fugu-icon-btn">
                    Discover More{" "}
          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <div className="fugu-iconbox-data">
                ...
                <p>
                  Crime insurance protects a company from loss of money,
                  securities, inventory from fraud events.
                </p>
                <Link href="single-service" legacyBehavior>
                  <a className="fugu-icon-btn">
                    Discover More{" "}
