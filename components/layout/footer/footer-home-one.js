        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="fugu-textarea">
              <div className="fugu-footer-logo">
                <img
                  src="/images/logo/prepd-footer-logo.svg"
                  alt=""
              ...
              <p className="fugu-copywright">
                &copy; Copyright 2023, All Rights Reserved by Prep'd
              </p>
            </div>
          </div>
          ...
          <div className="col-lg-2 col-md-6 col-sm-6">
            <div className="fugu-footer-menu">
              ...
              <ul>
                <li>
                  <Link href="tel:+966554451668">+966 55 445 1668 </Link>
                </li>
                <li>
                  <Link href="mailto:foodiecare@Prepdby.com">
